// Constants
const MAPBOX_TOKEN =
  // Set your Mapbox public token via the VITE_MAPBOX_TOKEN env var
  // (e.g. a GitHub Actions secret). Avoid committing tokens to source.
  // Apply URL restrictions: https://github.com/yihong0618/running_page/issues/643#issuecomment-2042668580
...
const nike = 'red'; // if you want to change the main color, modify this value
